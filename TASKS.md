...
- [x] **eSIM provisioning** — lpac → lpac-qmi-wrapper → qmi-send-apdu → QMI UIM → eUICC. Works on golden firmware. ISD-R AID filter bypassed by truncating to 6-byte prefix.
